...
import com.travel.tracker.adapters.CashCollectionAdapter;
...
public class cash_collection extends AppCompatActivity {
    ...
    private com.travel.tracker.adapters.CashCollectionAdapter mTimeLineAdapter;
...
//        cl.add(new CashModel("Pizza Hut, East Vikroli", "#198", 1110.00, "Handed Over", 0));
        ...
        List<CashModel> cl = new ArrayList<>();
        cl.add(new CashModel("", "", 0, "Handed Over", 0));
        cl.add(new CashModel("", "", 0, "Handed Over", 0));
        cl.add(new CashModel("", "", 0, "Handed Over", 0));
        cl.add(new CashModel("", "", 0, "Handed Over", 0));
        cl.add(new CashModel("", "", 0, "Handed Over", 0));
