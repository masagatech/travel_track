package com.travel.tracker.goyorider;
...
import com.travel.tracker.adapters.dashboard_menuAdapter;
import com.travel.tracker.gloabls.Global;
import com.travel.tracker.model.model_appsettings;
import com.travel.tracker.model.model_loginusr;
import com.travel.tracker.utils.SHP;
import com.travel.tracker.customer.clnt_mykids;
import com.travel.tracker.forms.my_trip;
                                                ...
                                                try {
                                                    ...
                                                    if (login.size() > 0) {
                                                        ...
                                                        if (m.getStatus() == 1) {
                                                            ...
                                                            Intent i = new Intent(MainActivity.this, com.travel.tracker.initials.login.class);
                                                            startActivity(i);
