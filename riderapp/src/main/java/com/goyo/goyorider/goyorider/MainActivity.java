package com.goyo.goyorider.goyorider;
...
import com.goyo.goyorider.adapters.dashboard_menuAdapter;
import com.goyo.goyorider.gloabls.Global;
import com.goyo.goyorider.model.model_appsettings;
import com.goyo.goyorider.model.model_loginusr;
import com.goyo.goyorider.utils.SHP;
import com.goyo.goyorider.customer.clnt_mykids;
import com.goyo.goyorider.forms.my_trip;
                                                ...
                                                try {
                                                    ...
                                                    if (login.size() > 0) {
                                                        ...
                                                        if (m.getStatus() == 1) {
                                                            ...
                                                            Intent i = new Intent(MainActivity.this, com.goyo.goyorider.initials.login.class);
                                                            startActivity(i);
