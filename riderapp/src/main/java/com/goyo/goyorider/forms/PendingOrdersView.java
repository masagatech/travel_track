...
public class PendingOrdersView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, com.goyo.goyorider.forms.Utils.dpToPx(20, mContext));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, com.goyo.goyorider.forms.Utils.dpToPx(2, mContext));
