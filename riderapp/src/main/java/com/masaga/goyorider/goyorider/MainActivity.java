package com.masaga.goyorider.goyorider;
...
import com.masaga.goyorider.adapters.dashboard_menuAdapter;
                                                ...
                                                try {
                                                    ...
                                                    if (login.size() > 0) {
                                                        ...
                                                        if (m.getStatus() == 1) {
                                                            ...
                                                            Intent i = new Intent(MainActivity.this, com.masaga.goyorider.initials.login.class);
                                                            startActivity(i);
