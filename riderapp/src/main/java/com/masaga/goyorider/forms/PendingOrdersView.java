...
public class PendingOrdersView extends View {
    ...
    public PendingOrdersView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, com.masaga.goyorider.forms.Utils.dpToPx(20, mContext));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, com.masaga.goyorider.forms.Utils.dpToPx(2, mContext));
